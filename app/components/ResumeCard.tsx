...
import ScoreCircle from "./ScoreCirecle";
import { usePuterStore } from "~/lib/puter";



const ResumeCard =({resume: {id, companyName,feedback, jobTitle, imagePath,resumePath}}: {resume: Resume}) =>{
        ...
        <Link to={`/resume/${id}`} className="resume-card animate-in fade-in duration-1000">
            <div className="resume-card-header">
                <div className="flex flex-col gap-2">
                    {/* conditionally render the resume image, company name and job title  */}
