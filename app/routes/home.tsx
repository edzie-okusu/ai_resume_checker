...
// export default function Home() {
//    const {fs, auth, kv} = usePuterStore();
...
//     useEffect(() => {
//         if(!auth.isAuthenticated) navigate('/auth?next=/home.tsx');
//     }, [auth.isAuthenticated])
...
//   return <main className="bg-[url('/images/bg-main.svg')] bg-cover justify-center items-center bg-cover">
//       <Navbar />
